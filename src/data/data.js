...
export const AllInstitutionsData = [
  ...
  // Bidirectional bond
  export const bidirectionalBond = (giveValue, getValue) => ({
    id: 2,
    type: "bidirectional",
    status: "active",
    users: [
  ...
  // Triangle bond
  export const triangleBond = (giveValue, getValue) => ({
    id: 3,
    type: "triangle",
    status: "active",
    users: [

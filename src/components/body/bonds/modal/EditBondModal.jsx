    ...
    >
      ...
      >
        <div className="relative p-6">
          ...
          <button
            onClick={onClose}
            className="absolute top-3 right-3 bg-primary rounded-full text-white hover:text-gray-700 cursor-pointer"
            aria-label="Close"
          >
          ...
          >
            ...
            <button
              type="submit"
              className="px-4 py-2 bg-primary text-white font-medium rounded-sm text-[10px] outline-none focus:ring-0 transition cursor-pointer"
            >
              Submit
            </button>
          </form>

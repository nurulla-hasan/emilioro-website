...
const FavoritePlaylist = () => {
    ...
    return (
        <div>
            {/* Cards */}
            <div className="xl:w-6/9 lg:w-5/6 mx-auto xl:mt-10 grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-5 lg:justify-between justify-items-center items-center">

...
const FavoriteAudio = () => {
    ...
    return (
        <div className="flex flex-col gap-8 justify-between xl:h-[calc(100vh-235px)] px-5 xl:px-0 mt-5 xl:mt-10">
            ...
            <div className="shadow-[0px_2px_9px_2px_rgba(147,_51,_234,_0.15)] rounded-md">
                <AudioPlayer />
            </div>

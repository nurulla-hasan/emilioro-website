...
const DonateUsFooter = () => {
    return (
        <footer className="bg-[#1a4585] text-white py-6 px-4 md:px-8">
            <div className=" max-w-7xl ml-[200] grid grid-cols-1 md:grid-cols-3 gap-10">
                {/* Logo and Description */}
                <div className="space-y-4 relative">
                    <div className="flex gap-3 items-center">

                        <div className=" border-[#FFFFFF] font-bold text-lg flex justify-center items-center gap-2 border-2 rounded-[100%] p-2">
                        ...
                        <h2 className="text-xl font-bold">Banckybondy</h2>
                    </div>
                    <p className="text-xs text-gray-200 absolute top-8 left-45">We are chatting</p>
                    <p className="text-sm font-[300] mt-12 w-[300]">

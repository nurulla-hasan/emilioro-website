  ...
  return (
    <div className="mx-auto my-16 w-3/4 px-5">
      ...
      <div className="flex items-center justify-between mx-auto">
        ...
        <h1 className="text-2xl my-5 font-bold text-blue-900">Browse & Join Project</h1>
      ...
      <div className='grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 items-center gap-5 rounded-lg'>
        {data.cards.map((card) => (
          <div key={card.id} className='flex flex-col gap-2 shadow-[0px_30px_25px_8px_#ebf4ff]'>
            <div>
              <img
                src={card.image.src}
                alt='image'

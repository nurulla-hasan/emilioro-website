            ...
            >
                ...
                >
                    ...
                    <div className="relative h-48">
                        <Image
                            src={selectedCard.image.src || "/placeholder.svg"}
                            alt="Project Header"
                            layout="fill"
                            objectFit="cover"
                        />
                    ...
                    <div className="p-6">
                        ...
                        <div className="flex items-center gap-2 mb-2">
                            <RiTeamLine className="text-blue-600" size={15} />
                            <span className="text-sm text-gray-800">{selectedCard.participant} Participent</span>
                        </div>

            ...
            <div className="md:w-2/3 px-4 py-8 mx-auto">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-3">
                    ...
                    <div>
                        <div className="flex justify-between items-center">
                            ...
                            <button
                                ...
                                className="cursor-pointer bg-button text-white text-xs px-4 py-1 rounded-sm"
                            >
                                + Add Skill
                            </button>
                        </div>
                    ...
                    <motion.button
                        ...
                        whileTap={{ scale: 0.95 }}
                        type="submit"
                        className="cursor-pointer w-full bg-button text-white py-2 rounded-sm font-semibold text-sm"
                    >
                        Save Changes
                    </motion.button>
                </form>

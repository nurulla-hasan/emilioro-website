        ...
        >
            <div className="md:w-2/3 px-5 py-10 mx-auto">
                ...
                <div className="mb-6 flex flex-col gap-[2px]">
                    <p className="text-center text-[#1C4587] font-medium cursor-pointer ">Change password</p>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-5">
                    {/* Current Password */}
                    <div>
                        <label className="block font-semibold text-sm mb-2">Current password</label>
                        <div className="relative">
                            <input
                                {...register("currentPassword", { required: "Current password is required" })}
                                type={showPassword.current ? "text" : "password"}
                                className="w-full border border-[#1c4587a8] rounded-lg p-2 pr-10"
                                placeholder="************"
                            />
                            <span
                    ...
                    <motion.button
                        ...
                        whileTap={{ scale: 0.95 }}
                        type="submit"
                        className="w-full bg-gradient-to-b from-[#1C4587] to-[#3279EA] text-white py-2 rounded-lg font-semibold text-lg"
                    >
                        Save changes
                    </motion.button>
                </form>

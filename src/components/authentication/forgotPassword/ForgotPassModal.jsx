        ...
        >
          ...
          >
            ...
            <div className="w-full md:w-1/2 p-8 md:p-12">
              <h2 className="text-primary text-lg font-semibold mb-6">Forgot Password</h2>
            ...
            <div className="w-full md:w-1/2 bg-[#C0D3F2] p-8 md:p-12 flex flex-col justify-center items-center text-center">
              <h2 className="text-primary text-lg font-semibold mb-2">Welcome to our forgot password page!</h2>

  ...
  return (
    ...
    <div className="bg-[#1C4587] px-5">
      <motion.section
        initial="hidden"
        animate="visible"
        className="mx-auto lg:w-6/9 lg:h-[calc(100vh-90px)] h-[calc(100vh-64px)] flex lg:flex-row flex-col text-white items-center justify-center text-center relative overflow-hidden "
      >
        {/* Left Content */}

...
const MyPlaylist = () => {
    ...
    return (
        <div className="px-5 my-5 md:px-8">
            ...
            {/* Cards */}
            <div className="grid items-center grid-cols-1 gap-5 mx-auto my-5 xl:grid-cols-3 3xl:grid-cols-4 lg:grid-cols-2 md:grid-cols-2 lg:justify-between justify-items-center">

...
const ObjectPage = () => {
    ...
    return (
        <div className='min-h-screen lg:w-2/3  mx-auto mt-10 mb-20'>
            ...
            {/* Tabs------ */}
            <div className="flex mx-auto lg:ml-0 border-[#1C4587] border w-80 justify-between rounded-sm mt-5 lg:mt-10">
                {[
...
const MyProjects = () => (
    <div className='relative '>
        <div className='absolute -top-10 right-[40%] lg:-top-[84px] lg:right-0 border border-[#1e4a9b] px-1 rounded-sm bg-white'>
...
const JoinedProjects = () => (
    <div className='relative'>
        <div className='absolute -top-10 right-[40%] lg:-top-[84px] lg:right-0 border border-[#1e4a9b] px-1 rounded-sm'>
            <select className='text-xs text outline-none py-1'>
                <option value="">Active</option>
                <option value="">Completed</option>
            </select>

...
const Page = () => {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto my-8 bg-white shadow-sm rounded-md overflow-hidden">
      {/* Header */}
        ...
        <div className="space-y-4">
          {comments.map((comment) => (
            <div key={comment.id} className="bg-white p-5 rounded-md shadow-sm">
              ...
              <p className="text-sm text-gray-700 mt-3 leading-relaxed">{comment.content}</p>
            </div>
          ))}
        </div>
      </div>

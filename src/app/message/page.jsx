      ...
      <div className="flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        >
          <Link href='/bonds/myBond'>
            <button className="cursor-pointer text-sm bg-gradient-to-b from-[#1C4587] to-[#3279EA] text-white px-4 py-2 rounded-md font-medium">
              +Add Group
            </button>
          </Link>
        </motion.div>
      </div>
      <div className="flex h-[75vh] bg-white border mt-5 border-blue-200 rounded-md mb-10">

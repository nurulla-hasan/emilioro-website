...
const ChatInterface = () => {
  ...
  const recentChats = [
    ...
    },
    {
      ...
      time: "10 minutes",
      avatar: "https://images.unsplash.com/photo-1654110455429-cf322b40a906?q=80&w=2080&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
      messages: [
    ...
    },
    {
      ...
      time: "2 minutes",
      avatar: "https://images.unsplash.com/photo-1507494866709-e881bd11477e?q=80&w=2080&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
      isGroup: true,
      participants: [
  ...
  return (
    <div className="w-full md:w-11/12 lg:w-7/8 xl:w-6/9 mx-auto px-4 md:px-6 mt-5">
      <div className="flex md:flex-row justify-between items-center gap-4">
        ...
        <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
          <button
            ...
            className="cursor-pointer text-xs md:text-sm bg-gradient-to-b from-[#1C4587] to-[#3279EA] text-white px-4 py-2 rounded-md md:font-medium"
          >
            +Add Group
          </button>
        </motion.div>
      ...
      <div className="h-[78vh] flex bg-white border-2 mt-5 border-[#ABC4ED] rounded-md mb-10 overflow-hidden">
        ...
        <div className={`border-l border-[#ABC4ED] p-3 lg:flex flex-col justify-between ${!isVisible ? "hidden" : ""}`}>
          ...
          <div className="text-center mt-auto pt-4">
            <button
              ...
              className="text-white font-medium rounded-lg px-3 py-2 text-sm bg-gradient-to-b from-[#1C4587] to-[#3279EA]"
            >
              Mark as complete
            </button>
          </div>

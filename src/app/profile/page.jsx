...
const ProfilePage = () => {
    ...
    const profileData = {
        ...
        friends: [
            { name: "MR. Sarwar", role: "Artist", avatar: "/heroImage.png" },
            { name: "MR. Fahad", role: "Engineer", avatar: "/heroImage.png" },
            { name: "Ahmad Musa", role: "Emam", avatar: "/heroImage.png" },
            { name: "MR. TA Emon", role: "Biker", avatar: "/heroImage.png" },
            { name: "MR. Mehehi", role: "Artist", avatar: "/heroImage.png" },
            { name: "MR. Dindinia", role: "Artist", avatar: "/heroImage.png" },
            { name: "MR. Nahid", role: "Scientist", avatar: "/heroImage.png" },
            { name: "Ahmad Mus", role: "Emam", avatar: "/heroImage.png" },
        ],
        life_story: {
            events: [
                {
        ...
        <div className="lg:w-5/6 xl:w-6/9 px-5 my-10 mx-auto">
            ...
            <div className="mt-8">
                ...
                <div className="mt-8">
                    ...
                    <div className="grid grid-cols-4 sm:grid-cols-8 gap-x-2 gap-y-4 w-3/4 mx-auto">
                ...
                <div className="mt-12">
                    ...
                    <div className="flex flex-col md:flex-row gap-6">
                        {/* Life Events Column */}
                        <div className="w-full md:w-2/7 flex-1/2 bg-white p-4 rounded-lg shadow-[0px_19px_48px_1px_#CFC9DDB2]">
            ...
            <div className="mt-8">
                <div className="mt-12 mb-8">
                    ...
                    <div className="flex flex-col gap-2 md:flex-row justify-between items-center mb-6">
                        ...
                        <button className="bg-gradient-to-b from-[#1C4587] to-[#3279EA]  text-white text-md px-3 py-2 rounded-md flex items-center">
